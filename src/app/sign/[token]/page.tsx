...
export default async function SignPage({
  ...
  const logoUrl = /stor\s*24/i.test(organisation.name) ? "/brand/stor24-logo-email.svg?v=official-20260827" : organisation.logoKey ? `/api/brand/${organisation.id}/logo?v=${organisation.updatedAt.getTime()}` : organisation.logoUrl;
